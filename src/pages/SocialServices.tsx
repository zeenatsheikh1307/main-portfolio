...
const socialCampaigns = [
  {
    ...
    videoUrl:
      "https://player.vimeo.com/external/371433846.sd.mp4?s=236da2f3c0fd273d2c6d9a25b481976e93d36b8b&profile_id=164&oauth2_token_id=57447761",
    platform: "LinkedIn",
    engagement: "2.4M",
    growth: "+340%",
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-foreground transition-colors duration-300 overflow-x-hidden">
      ...
      <section
        id="services"
        ref={servicesRef}
        className="md:pl-24 px-4 md:px-6 py-16 md:py-24 bg-gradient-to-b from-[#0a0a0f] via-[#0d0d14] to-[#0a0a0f]"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-2xl mx-auto text-lg">
              ...
              communities and drives meaningful engagement
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              },
              {
                ...
                gradient:
                  "from-purple-900/50 via-purple-800/30 to-purple-950/20",
              ...
              },
              {
                ...
                gradient:
                  "from-yellow-900/50 via-yellow-800/30 to-yellow-950/20",
              ...
              },
              {
                ...
                gradient:
                  "from-orange-900/50 via-orange-800/30 to-orange-950/20",
                iconColor: "text-orange-400",
              },
            ].map((service, index) => (
              <div
                key={index}
                className={`service-card group relative bg-gradient-to-br ${service.gradient} backdrop-blur-xl rounded-3xl p-8 md:p-10 border border-white/10 hover:border-white/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-3 min-h-[320px] flex flex-col justify-between overflow-hidden shadow-xl`}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative z-10">
                  <div
                    className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 flex items-center justify-center mb-6`}
                  >
                    <service.icon
                      className={`w-7 h-7 md:w-8 md:h-8 ${service.iconColor}`}
                    />
                  </div>
      ...
      <section className="relative md:pl-24 px-4 md:px-6 py-12 md:py-20 overflow-hidden bg-[#0a0a0f]">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ref={projectsRef}
            className="flex gap-6 overflow-x-auto py-4 px-2 snap-x snap-mandatory scrollbar-hide pb-12"
          >
            {socialCampaigns.map((campaign) => (
              <article
                key={campaign.id}
                className="campaign-card group snap-start w-[380px] flex-shrink-0 rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a1a2e]/95 to-[#16162a]/60 backdrop-blur-xl border border-white/10 hover:border-purple-400/60 transition-all duration-500"
              >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div
                key={i}
                className="group bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl p-6 text-center transition-all duration-300"
              >
