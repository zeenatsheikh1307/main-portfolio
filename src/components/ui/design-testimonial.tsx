...
const testimonials = [
    {
        quote: "No confusion. No guesswork. We always knew exactly what was happening.",
        author: "Sarah Chen",
        role: "Design Director",
        company: "Linear",
    },
    {
        quote: "They didn't just deliver; they stayed to help us grow. A true partnership.",
        author: "Marcus Webb",
        role: "Creative Lead",
        company: "Vercel",
    },
    {
        quote: "Pure craftsmanship in every single detail. Nothing rushed, nothing half-done.",
        author: "Elena Frost",
...
export function Testimonial() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-background overflow-hidden p-4">
            <div ref={containerRef} className="relative w-full max-w-5xl" onMouseMove={handleMouseMove}>
                ...
                <motion.div
                    className="absolute -left-8 top-1/2 -translate-y-1/2 text-[12rem] md:text-[20rem] lg:text-[28rem] font-bold text-foreground/[0.03] select-none pointer-events-none leading-none tracking-tighter"
                    ...
                    <div className="flex-1 md:pl-16 py-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-8">
                            ...
                            <div className="flex items-center gap-4">
                                <motion.button
                                    onClick={goPrev}
                                    className="group relative w-12 h-12 rounded-full border border-border flex items-center justify-center overflow-hidden bg-background"
                                    whileTap={{ scale: 0.95 }}
                                >
                                    <motion.div
                                    ...
                                    />
                                    <ChevronLeft className="relative z-10 w-4 h-4 text-foreground group-hover:text-background transition-colors" />
                                </motion.button>
                                ...
                                >
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
                                    />
                                    <ChevronRight className="relative z-10 w-4 h-4 text-foreground group-hover:text-background transition-colors" />
                                </motion.button>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        {[...Array(10)].map((_, i) => (
                            <span key={i} className="mx-8">
                                METABULL UNIVERSE • CLEAR COMMUNICATION • CONSISTENT QUALITY • RELIABLE PARTNERSHIP •
                            </span>
                        ))}
                    </motion.div>
                </div>
